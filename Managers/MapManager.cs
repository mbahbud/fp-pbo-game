...
namespace Winter_Defense.Managers
{
    class PhysicalObject
    {
        ...
        private static PhysicalObject _instance = null;
        ...
        public bool TileIntersectsPlayer(Rectangle player, Rectangle block, SceneGameover.Direction direction, out Vector2 depth)
        {
            depth = direction == SceneGameover.Direction.Vertical ? new Vector2(0, player.GetVerticalIntersectionDepth(block)) : new Vector2(player.GetHorizontalIntersectionDepth(block), 0);
